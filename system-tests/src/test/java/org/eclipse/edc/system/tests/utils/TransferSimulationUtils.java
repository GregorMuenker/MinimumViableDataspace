...
public abstract class TransferSimulationUtils {
    ...
    public static final String PROVIDER_ASSET_ID = "test-document_lieferant1";
    public static final String EU_RESTRICTED_PROVIDER_ASSET_ID = "test-document-2_lieferant1";
    ...
    private static HttpRequestActionBuilder getContractStatus() {
        return http("Get status")
                ...
                .checkIf(
                        session -> ContractNegotiationStates.PROVIDER_FINALIZED.name().equals(session.getString("status"))
                ).then(
